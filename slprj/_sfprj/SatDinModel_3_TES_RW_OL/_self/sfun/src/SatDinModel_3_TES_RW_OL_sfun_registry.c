...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_SatDinModel_3_TES_RW_OL_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_SatDinModel_3_TES_RW_OL_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_SatDinModel_3_TES_RW_OL_autoinheritance_info( int nlhs,
  ...
  if (strcmp(machineName, "SatDinModel_3_TES_RW_OL") == 0) {
    const mxArray *newRhs[2] = { NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_SatDinModel_3_TES_RW_OL_autoinheritance_info(nlhs,plhs,2,newRhs);
  }
...
{
  extern unsigned int sf_SatDinModel_3_TES_RW_OL_get_eml_resolved_functions_info
  ...
  if (strcmp(machineName, "SatDinModel_3_TES_RW_OL") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_SatDinModel_3_TES_RW_OL_get_eml_resolved_functions_info(nlhs,plhs,
      2,newRhs);
  }
...
extern unsigned int sf_SatDinModel_3_TES_RW_OL_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"SatDinModel_3_TES_RW_OL")) {
    return(sf_SatDinModel_3_TES_RW_OL_method_dispatcher(simstructPtr,
...
extern void SatDinModel_3_TES_RW_OL_terminator(void);
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    SatDinModel_3_TES_RW_OL_terminator();
    sf_debug_terminate();
  }
...
extern void SatDinModel_3_TES_RW_OL_initializer(void);
extern void SatDinModel_3_TES_RW_OL_register_exported_symbols(SimStruct* S);
extern void SatDinModel_3_TES_RW_OL_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  SatDinModel_3_TES_RW_OL_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      SatDinModel_3_TES_RW_OL_debug_initialize();
    }

    SatDinModel_3_TES_RW_OL_initializer();
  }
