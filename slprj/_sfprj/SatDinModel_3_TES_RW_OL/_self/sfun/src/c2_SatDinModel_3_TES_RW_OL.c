...
#include "SatDinModel_3_TES_RW_OL_sfun_debug_macros.h"
...
static void initialize_c2_SatDinModel_3_TES_RW_OL
  (SFc2_SatDinModel_3_TES_RW_OLInstanceStruct *chartInstance);
static void initialize_params_c2_SatDinModel_3_TES_RW_OL
  (SFc2_SatDinModel_3_TES_RW_OLInstanceStruct *chartInstance);
static void enable_c2_SatDinModel_3_TES_RW_OL
  (SFc2_SatDinModel_3_TES_RW_OLInstanceStruct *chartInstance);
static void disable_c2_SatDinModel_3_TES_RW_OL
  (SFc2_SatDinModel_3_TES_RW_OLInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_SatDinModel_3_TES_RW_OL
  (SFc2_SatDinModel_3_TES_RW_OLInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_SatDinModel_3_TES_RW_OL
  (SFc2_SatDinModel_3_TES_RW_OLInstanceStruct *chartInstance);
static void set_sim_state_c2_SatDinModel_3_TES_RW_OL
  (SFc2_SatDinModel_3_TES_RW_OLInstanceStruct *chartInstance, const mxArray
   *c2_st);
static void finalize_c2_SatDinModel_3_TES_RW_OL
  (SFc2_SatDinModel_3_TES_RW_OLInstanceStruct *chartInstance);
static void sf_c2_SatDinModel_3_TES_RW_OL
  (SFc2_SatDinModel_3_TES_RW_OLInstanceStruct *chartInstance);
static void c2_chartstep_c2_SatDinModel_3_TES_RW_OL
  (SFc2_SatDinModel_3_TES_RW_OLInstanceStruct *chartInstance);
static void initSimStructsc2_SatDinModel_3_TES_RW_OL
  (SFc2_SatDinModel_3_TES_RW_OLInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_SatDinModel_3_TES_RW_OLInstanceStruct
  *chartInstance, const mxArray *c2_y, const char_T *c2_identifier, real_T
  c2_b_y[6]);
static void c2_b_emlrt_marshallIn(SFc2_SatDinModel_3_TES_RW_OLInstanceStruct
...
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_SatDinModel_3_TES_RW_OLInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_d_emlrt_marshallIn(SFc2_SatDinModel_3_TES_RW_OLInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[12]);
...
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_e_emlrt_marshallIn(SFc2_SatDinModel_3_TES_RW_OLInstanceStruct *
  chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_f_emlrt_marshallIn(SFc2_SatDinModel_3_TES_RW_OLInstanceStruct *
  chartInstance, const mxArray *c2_b_is_active_c2_SatDinModel_3_TES_RW_OL, const
  char_T *c2_identifier);
static uint8_T c2_g_emlrt_marshallIn(SFc2_SatDinModel_3_TES_RW_OLInstanceStruct *
  chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_SatDinModel_3_TES_RW_OLInstanceStruct
  *chartInstance);
  ...
  (SFc2_SatDinModel_3_TES_RW_OLInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_SatDinModel_3_TES_RW_OL = 0U;
}
  ...
  (SFc2_SatDinModel_3_TES_RW_OLInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_SatDinModel_3_TES_RW_OL;
   ...
   *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_SatDinModel_3_TES_RW_OL = c2_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
     "is_active_c2_SatDinModel_3_TES_RW_OL");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_SatDinModel_3_TES_RW_OL(chartInstance);
  ...
  (SFc2_SatDinModel_3_TES_RW_OLInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_SatDinModel_3_TES_RW_OL(chartInstance);
  sf_debug_check_for_state_inconsistency(_SatDinModel_3_TES_RW_OLMachineNumber_,
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_SatDinModel_3_TES_RW_OLInstanceStruct *chartInstance;
  chartInstance = (SFc2_SatDinModel_3_TES_RW_OLInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c2_SatDinModel_3_TES_RW_OL_get_eml_resolved_functions_info
  (void)
{
  ...
  char_T *c2_identifier)
{
  ...
  c2_y = c2_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_SatDinModel_3_TES_RW_OL), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_SatDinModel_3_TES_RW_OL);
  return c2_y;
}
...
/* SFunction Glue Code */
void sf_c2_SatDinModel_3_TES_RW_OL_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_SatDinModel_3_TES_RW_OL_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_SatDinModel_3_TES_RW_OL(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c2_SatDinModel_3_TES_RW_OL\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_SatDinModel_3_TES_RW_OL_get_check_sum(&mxChecksum);
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (_SatDinModel_3_TES_RW_OLMachineNumber_,
           2,
           1,
           1,
           2,
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_SatDinModel_3_TES_RW_OLMachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (_SatDinModel_3_TES_RW_OLMachineNumber_,chartInstance->chartNumber,1);
      ...
      sf_debug_reset_current_state_configuration
        (_SatDinModel_3_TES_RW_OLMachineNumber_,chartInstance->chartNumber,
         chartInstance->instanceNumber);
    }
  }
}

static void sf_opaque_initialize_c2_SatDinModel_3_TES_RW_OL(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_SatDinModel_3_TES_RW_OLInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_SatDinModel_3_TES_RW_OL
    ((SFc2_SatDinModel_3_TES_RW_OLInstanceStruct*) chartInstanceVar);
  initialize_c2_SatDinModel_3_TES_RW_OL
    ((SFc2_SatDinModel_3_TES_RW_OLInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_SatDinModel_3_TES_RW_OL(void *chartInstanceVar)
{
  enable_c2_SatDinModel_3_TES_RW_OL((SFc2_SatDinModel_3_TES_RW_OLInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_SatDinModel_3_TES_RW_OL(void *chartInstanceVar)
{
  disable_c2_SatDinModel_3_TES_RW_OL((SFc2_SatDinModel_3_TES_RW_OLInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_SatDinModel_3_TES_RW_OL(void *chartInstanceVar)
{
  sf_c2_SatDinModel_3_TES_RW_OL((SFc2_SatDinModel_3_TES_RW_OLInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_SatDinModel_3_TES_RW_OL
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_SatDinModel_3_TES_RW_OL
    ((SFc2_SatDinModel_3_TES_RW_OLInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_SatDinModel_3_TES_RW_OL();/* state var info */
...
extern void sf_internal_set_sim_state_c2_SatDinModel_3_TES_RW_OL(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_SatDinModel_3_TES_RW_OL
    ((SFc2_SatDinModel_3_TES_RW_OLInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_SatDinModel_3_TES_RW_OL
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c2_SatDinModel_3_TES_RW_OL(S);
}

static void sf_opaque_set_sim_state_c2_SatDinModel_3_TES_RW_OL(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c2_SatDinModel_3_TES_RW_OL(S, st);
}

static void sf_opaque_terminate_c2_SatDinModel_3_TES_RW_OL(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_SatDinModel_3_TES_RW_OLInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_SatDinModel_3_TES_RW_OL
      ((SFc2_SatDinModel_3_TES_RW_OLInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_SatDinModel_3_TES_RW_OL
    ((SFc2_SatDinModel_3_TES_RW_OLInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_SatDinModel_3_TES_RW_OL(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_SatDinModel_3_TES_RW_OL
      ((SFc2_SatDinModel_3_TES_RW_OLInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_SatDinModel_3_TES_RW_OL(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"SatDinModel_3_TES_RW_OL",
      "SatDinModel_3_TES_RW_OL",2);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"SatDinModel_3_TES_RW_OL",
                "SatDinModel_3_TES_RW_OL",2,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,
      "SatDinModel_3_TES_RW_OL","SatDinModel_3_TES_RW_OL",2,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"SatDinModel_3_TES_RW_OL",
        "SatDinModel_3_TES_RW_OL",2,1);
      sf_mark_chart_reusable_outputs(S,"SatDinModel_3_TES_RW_OL",
        "SatDinModel_3_TES_RW_OL",2,1);
    }

    sf_set_rtw_dwork_info(S,"SatDinModel_3_TES_RW_OL","SatDinModel_3_TES_RW_OL",
                          2);
...
static void mdlRTW_c2_SatDinModel_3_TES_RW_OL(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "SatDinModel_3_TES_RW_OL",
      "SatDinModel_3_TES_RW_OL",2);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c2_SatDinModel_3_TES_RW_OL(SimStruct *S)
{
  SFc2_SatDinModel_3_TES_RW_OLInstanceStruct *chartInstance;
  chartInstance = (SFc2_SatDinModel_3_TES_RW_OLInstanceStruct *)malloc(sizeof
    (SFc2_SatDinModel_3_TES_RW_OLInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_SatDinModel_3_TES_RW_OLInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_SatDinModel_3_TES_RW_OL;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_SatDinModel_3_TES_RW_OL;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_SatDinModel_3_TES_RW_OL;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_SatDinModel_3_TES_RW_OL;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_SatDinModel_3_TES_RW_OL;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_SatDinModel_3_TES_RW_OL;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_SatDinModel_3_TES_RW_OL;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_SatDinModel_3_TES_RW_OL;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_SatDinModel_3_TES_RW_OL;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_SatDinModel_3_TES_RW_OL;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_SatDinModel_3_TES_RW_OL;
...
void c2_SatDinModel_3_TES_RW_OL_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_SatDinModel_3_TES_RW_OL(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_SatDinModel_3_TES_RW_OL(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_SatDinModel_3_TES_RW_OL(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_SatDinModel_3_TES_RW_OL_method_dispatcher.\n"
