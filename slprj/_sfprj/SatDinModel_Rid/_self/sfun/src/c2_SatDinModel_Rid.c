...
#include "SatDinModel_Rid_sfun.h"
#include "c2_SatDinModel_Rid.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "SatDinModel_Rid_sfun_debug_macros.h"
...
static void initialize_c2_SatDinModel_Rid(SFc2_SatDinModel_RidInstanceStruct
  *chartInstance);
static void initialize_params_c2_SatDinModel_Rid
  (SFc2_SatDinModel_RidInstanceStruct *chartInstance);
static void enable_c2_SatDinModel_Rid(SFc2_SatDinModel_RidInstanceStruct
  *chartInstance);
static void disable_c2_SatDinModel_Rid(SFc2_SatDinModel_RidInstanceStruct
  *chartInstance);
static void c2_update_debugger_state_c2_SatDinModel_Rid
  (SFc2_SatDinModel_RidInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_SatDinModel_Rid
  (SFc2_SatDinModel_RidInstanceStruct *chartInstance);
static void set_sim_state_c2_SatDinModel_Rid(SFc2_SatDinModel_RidInstanceStruct *
  chartInstance, const mxArray *c2_st);
static void finalize_c2_SatDinModel_Rid(SFc2_SatDinModel_RidInstanceStruct
  *chartInstance);
static void sf_c2_SatDinModel_Rid(SFc2_SatDinModel_RidInstanceStruct
  *chartInstance);
static void c2_chartstep_c2_SatDinModel_Rid(SFc2_SatDinModel_RidInstanceStruct
  *chartInstance);
static void initSimStructsc2_SatDinModel_Rid(SFc2_SatDinModel_RidInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_SatDinModel_RidInstanceStruct
  *chartInstance, const mxArray *c2_y, const char_T *c2_identifier, real_T
  c2_b_y[6]);
static void c2_b_emlrt_marshallIn(SFc2_SatDinModel_RidInstanceStruct
...
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_SatDinModel_RidInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_d_emlrt_marshallIn(SFc2_SatDinModel_RidInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[12]);
...
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_e_emlrt_marshallIn(SFc2_SatDinModel_RidInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_f_emlrt_marshallIn(SFc2_SatDinModel_RidInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_SatDinModel_Rid, const char_T
  *c2_identifier);
static uint8_T c2_g_emlrt_marshallIn(SFc2_SatDinModel_RidInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_SatDinModel_RidInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_SatDinModel_Rid = 0U;
}
  ...
  (SFc2_SatDinModel_RidInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_SatDinModel_Rid;
  ...
  chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_SatDinModel_Rid = c2_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
     "is_active_c2_SatDinModel_Rid");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_SatDinModel_Rid(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_SatDinModel_Rid(chartInstance);
  sf_debug_check_for_state_inconsistency(_SatDinModel_RidMachineNumber_,
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_SatDinModel_RidInstanceStruct *chartInstance;
  chartInstance = (SFc2_SatDinModel_RidInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_SatDinModel_Rid_get_eml_resolved_functions_info(void)
{
  ...
  *c2_identifier)
{
  ...
  c2_y = c2_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_SatDinModel_Rid), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_SatDinModel_Rid);
  return c2_y;
}
...
/* SFunction Glue Code */
void sf_c2_SatDinModel_Rid_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_SatDinModel_Rid_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_SatDinModel_Rid(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c2_SatDinModel_Rid\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_SatDinModel_Rid_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_SatDinModel_RidInstanceStruct *chartInstance;
    chartInstance = (SFc2_SatDinModel_RidInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (_SatDinModel_RidMachineNumber_,
           2,
           1,
           1,
           2,
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_SatDinModel_RidMachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (_SatDinModel_RidMachineNumber_,chartInstance->chartNumber,1);
          sf_debug_set_chart_event_thresholds(_SatDinModel_RidMachineNumber_,
            chartInstance->chartNumber,
            0,
            0,
            0);
      ...
      sf_debug_reset_current_state_configuration(_SatDinModel_RidMachineNumber_,
        chartInstance->chartNumber,chartInstance->instanceNumber);
    }
  }
}

static void sf_opaque_initialize_c2_SatDinModel_Rid(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_SatDinModel_RidInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_SatDinModel_Rid((SFc2_SatDinModel_RidInstanceStruct*)
    chartInstanceVar);
  initialize_c2_SatDinModel_Rid((SFc2_SatDinModel_RidInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_SatDinModel_Rid(void *chartInstanceVar)
{
  enable_c2_SatDinModel_Rid((SFc2_SatDinModel_RidInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_SatDinModel_Rid(void *chartInstanceVar)
{
  disable_c2_SatDinModel_Rid((SFc2_SatDinModel_RidInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_SatDinModel_Rid(void *chartInstanceVar)
{
  sf_c2_SatDinModel_Rid((SFc2_SatDinModel_RidInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_SatDinModel_Rid(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_SatDinModel_Rid
    ((SFc2_SatDinModel_RidInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_SatDinModel_Rid();/* state var info */
...
extern void sf_internal_set_sim_state_c2_SatDinModel_Rid(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_SatDinModel_Rid((SFc2_SatDinModel_RidInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_SatDinModel_Rid(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_SatDinModel_Rid(S);
}

static void sf_opaque_set_sim_state_c2_SatDinModel_Rid(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c2_SatDinModel_Rid(S, st);
}

static void sf_opaque_terminate_c2_SatDinModel_Rid(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_SatDinModel_RidInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_SatDinModel_Rid((SFc2_SatDinModel_RidInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_SatDinModel_Rid((SFc2_SatDinModel_RidInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_SatDinModel_Rid(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_SatDinModel_Rid(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"SatDinModel_Rid","SatDinModel_Rid",2);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"SatDinModel_Rid","SatDinModel_Rid",2,
                "RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"SatDinModel_Rid",
      "SatDinModel_Rid",2,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"SatDinModel_Rid","SatDinModel_Rid",
        2,1);
      sf_mark_chart_reusable_outputs(S,"SatDinModel_Rid","SatDinModel_Rid",2,1);
    }

    sf_set_rtw_dwork_info(S,"SatDinModel_Rid","SatDinModel_Rid",2);
...
static void mdlRTW_c2_SatDinModel_Rid(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "SatDinModel_Rid", "SatDinModel_Rid",2);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c2_SatDinModel_Rid(SimStruct *S)
{
  SFc2_SatDinModel_RidInstanceStruct *chartInstance;
  chartInstance = (SFc2_SatDinModel_RidInstanceStruct *)malloc(sizeof
    (SFc2_SatDinModel_RidInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_SatDinModel_RidInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_SatDinModel_Rid;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_SatDinModel_Rid;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_SatDinModel_Rid;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_SatDinModel_Rid;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_SatDinModel_Rid;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_SatDinModel_Rid;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_SatDinModel_Rid;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_SatDinModel_Rid;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_SatDinModel_Rid;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_SatDinModel_Rid;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_SatDinModel_Rid;
...
void c2_SatDinModel_Rid_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_SatDinModel_Rid(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_SatDinModel_Rid(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_SatDinModel_Rid(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_SatDinModel_Rid_method_dispatcher.\n"
